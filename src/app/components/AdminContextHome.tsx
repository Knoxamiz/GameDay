...
export default function AdminContextHome({
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020817] text-white">
      ...
      <header className="relative z-[900] border-b border-white/10 bg-slate-950/70 backdrop-blur">
        <div className="mx-auto flex min-h-16 max-w-[1120px] items-center justify-between px-4 sm:px-6">
          ...
          <div className="relative z-[910]">
            ...
            {isProfileOpen && (
              <div className="absolute right-0 top-full z-[920] mt-2 w-64 rounded-lg border border-blue-300/20 bg-slate-950 p-2 shadow-[0_18px_48px_rgba(0,0,0,0.5)]">
                {accountLabel && (

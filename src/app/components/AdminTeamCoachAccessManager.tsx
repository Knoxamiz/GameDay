...
export default function AdminTeamCoachAccessManager({
  ...
  return (
    <section className="gd-card-dark rounded-lg p-3 backdrop-blur">
      ...
      <details className="group mt-2 overflow-hidden rounded-md border border-blue-300/15 bg-slate-950/30">
        <summary className="flex cursor-pointer list-none items-center justify-between gap-3 px-3 py-2 text-sm font-black text-blue-100 [&::-webkit-details-marker]:hidden">
          <span>Add coach by email</span>
          <span className="text-lg transition group-open:rotate-90">&rsaquo;</span>
        </summary>
        <div className="grid gap-2 border-t border-white/10 p-2 md:grid-cols-[1fr_1.3fr_auto]">
          <input
